									...
									db.transaction(
											...
											function()  {
														...
														if(!inBackground)
														{
															...
															"</div>";*/	
															var popNitfiche = "";
															popNitfiche+="<div id='box"+ID_notizia+"'  class='notification notification-info box_notifica'>";
															popNitfiche+="<a data-itemid='"+ID_notizia+"' class='close-notification no-smoothState'><i id='closePopupNotifica' class='ion-android-close'></i></a>"
