...
function loginUtente(usernameLogin,passLogin)
{
       ...
       $.ajax({
		...
		if(login!="")
        {
            ...
            var li_dati="<span style='font-size:11px !important; color:#fff; padding-left:10px;'>"+localStorage.getItem('username')+"</span><span class='logoutApp'><i style='font-size:15px !important;padding-left:15px;'  class='ion-log-out'></i></span>";
