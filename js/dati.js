...
function loginUtente(usernameLogin,passLogin)
{
       ...
       $.ajax({
		...
		if(login!="")
        {
            ...
            var li_dati="<i style='padding-left:15px;' class='ion-android-person'></i><span style='font-size:10px !important; color:#fff; padding-left:10px;'>Benvenuto "+localStorage.getItem('username')+"</span><i style='padding-left:15px;' id='#logout' class='ion-log-out'></i>";
