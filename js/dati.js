    ...
    if (checkInternet) {
        ...
        $.getJSON("http://magicbeep.mvclienti.com/webservices/get_indoorlocation.aspx", function (dati) {
            $.each(dati, function (i, name) {
                ...
                elenco_indoor += '<li><a href="#popup'+i+'" data-rel="dialog"><i class="ion-android-compass blue-text avatar circle"></i> <div class="comment-body"><span class="author uppercase">'+name.titolo_indoor+'</span></div></a><div id="popup'+i+'" class="modal"><div class="modal-content"><h4>'+name.titolo_indoor+'</h4><p>'+name.desc_indoor+'</p><img width="100%" src="http://magicbeep.mvclienti.com/public/upload_gallery/immagini/'+name.allegato_indoor+'"></div></div></li>';
