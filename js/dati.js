...
function successoSelect(tx,dati)
{
    ...
    if(len!=0)
    {
        for(var i=0; i<len; i++)
        {
            ...
            li_dati+="<div><span class='single-news-category'>"+dataCorretta+"</span></div><div class='single-news-channel'>"+dati.rows.item(i).descrizione.replace("<p>","").replace("</p>","").substring(0,80)+"...</div>";
